...
class Board extends Component {
    ...
    render() {
        ...
        for (var i = 0; i < 9; i++) {
            lines.push(
                <Line invalidCells={this.props.invalidCells} board={this.props.board} index={i} num={this.props.num} key={i} activeCell={this.props.activeCell} answer={this.props.answer} onPressCell={this.props.onPressCell.bind(this)} />
            )
        }
        return (
